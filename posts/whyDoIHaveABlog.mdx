...
Whilst developing my new personal website (this website), I decided to include a blog (this blog), and not just because developing a static blog would be an **interesting** __challenge__.
